<template lang="pug">
    div(ref="elem" id="text" class="input textarea clearfix custom stackoverflow" v-on:keyup="onKeyUp"  v-on:click="onClickTag" v-on:awesomplete-select="onAwesompleteSelect")
</template>
<script>
